...
const code = `const userState = defineState<{ name: string; role: string }>()
  .name("user")
  .variant("guest", true)
...
defineFlow(userState.guest, {
  login: (state, signal) => userState.authenticated({
    name: signal.name,
    role: signal.role
  })
})`
...
const tabs = [
  { name: 'manager.state.ts', isActive: true },
          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              ...
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                Immutable states, explicit signal feedback, and complete visibility.
                Build predictable applications with confidence.
              </p>
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                <Button href="/">Get started</Button>
                <Button href="https://github.com/ilya-pirogov/stateflow" variant="secondary">
                  View on GitHub
                </Button>
              </div>
            </div>
